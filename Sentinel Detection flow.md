...
![Sentinel detection flow: log data and threat intelligence feed an analytics rule, which emits alerts that group into incidents](assets/sentinel-detection-flow.png)
